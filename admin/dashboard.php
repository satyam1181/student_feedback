...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;background:#ff0100">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php" style="color:#ffff">Faculty Feedback System</a>
                <spam class="navbar-brand" style="color:#ffff"><?php echo $_SESSION['user'];?></spam>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation" style="background:#ffff">
                    ...
                    <ul class="nav" id="side-menu">
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="dashboard.php?info=faculty_import"><i class="glyphicon glyphicon-import"></i>Faculty Import</a>
                                </li>
								 <li>
                                    <a href="dashboard.php?info=show_faculty"><i class="fa fa-users"></i> Manage faculty</a>
                                </li>

                                <li>
                                    <a href="dashboard.php?info=mapping"><i class="fa fa-random"></i> Mapping Subject</a>
                                </li>								
							</ul>
                            <!-- /.nav-second-level -->
                        </li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
								 ...
								 <li>
                                    <a href="dashboard.php?info=display_student"><i class="fa fa-users"></i> Manage Student</a>
                                </li> 
                                 

                                 <li>
                                    <a href="dashboard.php?info=student_import"><i class="glyphicon glyphicon-import"></i>Import Student</a>
                                </li> 
...
<li><a href="dashboard.php?info=feedback"><i class="fa fa-eye"></i> feedback</a></li>
		...
		<li>
			<a href="dashboard.php?info=add_subject"><i class="fa fa-book"></i> Add Subject</a>
		</li>
...
<?php 
								...
								if($info!="")
								{
									...
									elseif($info=="feedback")
                                        ...
                                        else if($info=="faculty_import")
                                        {
                                            include('faculty_import.php');
                                        }
                                        else if($info=="student_import")
                                        {
