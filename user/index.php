...
//$sql=mysqli_query($conn,"select * from student where id='$user' ");
//$users=mysqli_fetch_assoc($sql);
$_SESSION['name']= $user_name['std_name'];
//$user_name['std_name']
$_SESSION['roll']= $user_name['id'];
$_SESSION['std_cource']= $user_name['std_cource'];
$_SESSION['std_dept']= $user_name['std_dept'];
$_SESSION['std_semester']= $user_name['std_semester'];
//print_r($user_name);
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background:#428bca">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style="color:#FFFFFF" href="#">Hello <?php echo $user_name['std_name'];?></a>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <li><a href="index.php?page=update"><span class="glyphicon glyphicon-asterisk"></span> Update </a></li>
