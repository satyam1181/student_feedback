...
<body>
    ...
    <li class="dropdown">
        <a style="color:#FFFFFF;" href="#" class="dropdown-toggle" data-toggle="dropdown" href="#"
onmouseover="this.style.backgroundColor='#0F0'" onmouseout="this.style.backgroundColor='#ff0100'"
        ><i class="fa fa-sign-in fa-fw"></i>Login
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          
          <li><a href="index.php?info=student_login"onmouseover="this.style.backgroundColor='#0F0'" onmouseout="this.style.backgroundColor='#ffff'">Student</a></li>
          <li><a href="index.php?info=faculty_login" onmouseover="this.style.backgroundColor='#0F0'" onmouseout="this.style.backgroundColor='#ffff'">Faculty</a></li> 
          <li><a href="admin" onmouseover="this.style.backgroundColor='#0F0'" onmouseout="this.style.backgroundColor='#ffff'">Admin</a></li> 
        </ul>
      </li> 
      
     <li>
                        <a style="color:#FFFFFF" href="index.php?info=contact" onmouseover="this.style.backgroundColor='#0F0'" onmouseout="this.style.backgroundColor='#ff0100'"><i class="fa fa-phone fa-fw"></i>Contact</a>
                    </li>
...
<?php 
                    ...
                    if($info!="")
                    {
                         ...
                         else if($info=="FacultyRequestReset")
                         {
                            include('FacultyRequestReset.php');
                         }
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/fd22.jpg');"></div>
                <div class="carousel-caption">
             ...
             <div class="item">
                <div class="fill" style="background-image:url('images/fd33.jpg');"></div>
                <div class="carousel-caption">
...
Before we can look into the php code, you need to create a database called "feed" with two tables in it..one as student and another one as take
    ...
    <div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background-color:black">
        <span style="color:">Developed By .......$uper Project Group</span>
    </div>
    <!-- jQuery -->
