...
{   
    ...
    $sql1 = mysqli_query($conn,"select faculity_email_id from faculity where faculity_email_id = '$emailTo' ");
...
try {
    ...
    // Content
    $url = "http://" . $_SERVER["HTTP_HOST"] . dirname($_SERVER["PHP_SELF"]). "/FacultyResetPassword.php?code=$code";
...
<form method="post">
	<div class="row">
		...
		<div class="col-sm-6"><h3>Faculty Reset Password</h2></div>
	</div>
