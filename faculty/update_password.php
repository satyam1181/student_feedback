...
$sql=mysqli_query($conn,"select * from faculity  where faculity_password='$op'");
...
if($r==true)
{
	...
	{
	//$np=md5($np);
	$sql=mysqli_query($conn,"update faculity set faculity_password='$np' where faculity_email_id='$user'");
