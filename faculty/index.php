...
$sql=mysqli_query($conn,"select * from faculity where faculity_email_id='$user' ");
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background:#428bca">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style="color:#FFFFFF" href="#">Hello <?php echo $users['faculity_name'];?></a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			{
			?>
            <li><a href="#"><img style="border-radius:50px" src="upload/<?php echo $users['photo'];?>" width="100" height="100" alt="not found"/></a></li>
			<?php 
			}
			else
			{
